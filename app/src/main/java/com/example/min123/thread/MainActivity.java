package com.example.min123.thread;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void threadclass(View v){
        ...
        ThreadSample thread1=new ThreadSample("THREAD ONE");
        thread1.start();
        ThreadSample thread2=new ThreadSample("THREAD TWO");
        thread2.start();
    }
    public void runnableinterface(View v){
        ...
        thread1.start();
        Thread thread2=new Thread(new RunnableExample("THREAD TWO"));
        thread2.start();
    }
    ...
    public void handlermessage(View v){
        final Handler myHandler=new Handler(){
            ...
            public void handleMessage(Message msg) {
                ...
                switch(msg.what){
                    case 1:
                        showmsg(String.valueOf(msg.arg1+msg.getData().get("attact").toString()));
                }
            }
        };
    ...
    public void asyntask(View v){
        class LearHard extends AsyncTask<Long,String,String>{
            private Context context;
            final int duration=10;int count=0;
            ...
            protected String doInBackground(Long... params) {
                ...
                while(count<duration){
                    num--;
                    count++;
                    String status="离毕业还有"+"秒，努力学习"+count+"秒。";
